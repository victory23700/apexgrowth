...
<head>
  ...
  <title>Sign Up - Apex Growth</title>
...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
  <div class="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md card-hover">
    <div class="text-center mb-8">
      ...
      <p class="text-gray-600 mt-2">Join Apex Growth today</p>
    </div>
    ...
    <div class="text-center mt-6 pt-6 border-t border-gray-200">
      <p class="text-gray-600">Already have an account? 
        <a href="loogin.php" class="text-blue-600 hover:text-blue-700 font-semibold">Sign in here</a>
      </p>
    </div>
  </div>
</body>
